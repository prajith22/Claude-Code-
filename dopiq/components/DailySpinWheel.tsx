...
export function DailySpinWheel({
  ...
  // On iOS, drop the Bet sector entirely and use the two-sector
  // half-disc variant. Sliceing math (start = center - half, end =
  // center + half) is parameterized off sectors.length so both
