...
// Each option has a `category` so we can filter the betting prompt
// out for iOS users (Apple disallows gambling features for
...
function Screen1({
  ...
  // developer accounts, so even asking the user to self-identify as
  // a bettor doesn't fit the iOS surface.
