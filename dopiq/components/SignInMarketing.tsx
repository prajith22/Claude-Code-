...
export function SignInMarketing({
  ...
  // iOS users never see the betting preview tile — Apple
  // disallows gambling features for individual developer
  // accounts. Filter the static SIMS list rather than rendering
  // and hiding so the grid stays balanced with two columns.
