...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/bet` | `/bet` | `/(tabs)/food` | `/food` | `/(tabs)/` | `/(tabs)` | `/(tabs)/shop` | `/shop` | `/(tabs)/tracker` | `/tracker` | `/bet/confirmed` | `/bet/history` | `/bet/place` | `/food/cart` | `/food/checkout` | `/food/tracker-delivery` | `/onboarding` | `/paywall` | `/shop/cart` | `/shop/checkout` | `/shop/confirmed`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/bet/${SingleRoutePart<T>}` | `/food/${SingleRoutePart<T>}` | `/shop/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/bet/[id]` | `/food/[id]` | `/shop/[id]`;
